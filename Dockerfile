...
RUN addgroup -S ${GROUP} -g ${GID} && adduser -D -S -u ${UID} ${USER} ${GROUP}  && \
    ...
    mkdir -p /opt/emby /config/ /opt/emby/ProgramData-Server/config/ && cd /tmp/ && wget -q "https://github.com/MediaBrowser/Emby/releases/download/${EMBY_VERSION}/Emby.Mono.zip" && \
